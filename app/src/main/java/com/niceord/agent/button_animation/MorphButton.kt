package com.niceord.agent.button_animation
...
class MorphButton @JvmOverloads constructor(
    ...
    var fromBgColor: Int = getColorX(R.color.purple_200)
    var toBgColor: Int = getColorX(R.color.gradient_top_color)
    var fromTextColor: Int = Color.BLACK
    var toTextColor: Int = getColorX(R.color.gradient_bottom_color)
    var btnRadius = 24 * dp()

    var iconDrawable = getDrawableX(R.drawable.ic_launcher_background)
        set(value) {
            field = value
            setSizeIcon()
        }
